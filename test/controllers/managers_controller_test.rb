...
class ManagersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post managers_url, params: { manager: { department_id: @manager.department_id, first_name: @manager.first_name, last_name: @manager.last_name } }
    end
  ...
  test "should update manager" do
    patch manager_url(@manager), params: { manager: { department_id: @manager.department_id, first_name: @manager.first_name, last_name: @manager.last_name } }
